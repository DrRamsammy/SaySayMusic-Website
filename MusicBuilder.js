...
@media(max-width:850px){.plan,.work,.options{grid-template-columns:1fr}.side{max-height:320px;overflow:auto}.brand b{font-size:17px}.tabs .tab{font-size:15px}.wrap{padding:12px}.card{padding:18px}}
</style></head><body>
